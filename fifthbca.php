...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js"></script>
        <link rel="stylesheet" type="text/css" href="stylebcafifth.css" /> 
        <link
          rel="stylesheet"
  ...
  <div class="container " style="background-color:#0D4C92;">
      ...
      <img src="images/logonew.png" alt="logo" width="120" height="30">
        ...
        <a class=" badge  bg-primary  shadow rounded-pill float-end text-nowrap shadow  " style=" color:white;width: 9rem; height:2rem; padding:10px 10px; text-decoration: none;"type="button" href="compiler.php"><i class="fa-solid fa-code"></i> Test them Online! </a>
  </div>
...
<div class="container-sm rounded-bottom shadow border " style="background-color:#ffffff;">
...
<br>
         <div class= "container align-baseline"  >
          <div class=" align-baseline alert alert-info alert-dismissible fade show shadow" role="alert"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-lightbulb" viewBox="0 0 16 16">
          <path d="M2 6a6 6 0 1 1 10.174 4.31c-.203.196-.359.4-.453.619l-.762 1.769A.5.5 0 0 1 10.5 13a.5.5 0 0 1 0 1 .5.5 0 0 1 0 1l-.224.447a1 1 0 0 1-.894.553H6.618a1 1 0 0 1-.894-.553L5.5 15a.5.5 0 0 1 0-1 .5.5 0 0 1 0-1 .5.5 0 0 1-.46-.302l-.761-1.77a1.964 1.964 0 0 0-.453-.618A5.984 5.984 0 0 1 2 6zm6-5a5 5 0 0 0-3.479 8.592c.263.254.514.564.676.941L5.83 12h4.342l.632-1.467c.162-.377.413-.687.676-.941A5 5 0 0 0 8 1z"/>
            </svg>
                    Just Click on the Codes to Copy them!
...
<div class="container rounded shadow" style="background-color: #EBF5FB ;">
    ...
    <div class="footer">
    <img src="images/logofooter.png" class="rounded float-start opacity-75" alt="..." width="80" height="20">
    <br>
    <br>
